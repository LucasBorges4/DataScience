...
print(f"\nValor de thresold calculado: {threshold}")
print("Usando o valor de trehsold calculado em cada um dos metodos de OTSU da opencv")
...
images = [image, output1, output2, output3, output4, output5,th2,th3]
titles = ["Original", "Binaria", "Binaria Inversa", "TOZERO", "TOZERO INV", "TRUNC","AdaptativeTreshMean","AdaptativeTreshGaussian"]
